      ...
      const realDelete = () => {
       ...
       const allClick = () => {
           if(document.getElementById('ck_all').checked){
               for(let i=0;i<document.admin_page_bbs_delete.ck.length;i++){
                   document.admin_page_bbs_delete.ck[i].checked = true;
              }
           }else{
              for(let i=0;i<document.admin_page_bbs_delete.ck.length;i++){
                   document.admin_page_bbs_delete.ck[i].checked = false;
              }
           }
       }
...
<%@ include file="adminPageHeader.jsp" %>
    ...
    <div id="div_table">
        ...
        <form name="admin_page_bbs_delete" action="admin_page_bbs_delete_ok.jsp" onsubmit="return realDelete()">
                   ...
                   <%   
                    ...
                    %>
                            <tr>
                             ...
                             <td>
                             <%
                           for(int z = 1; z <= dto.getBbs_lev(); z++){
                              out.println("&nbsp;&nbsp;");
                           }
                        %>
            ...
            <span id="write">
                <input type="button" value="글쓰기" class="b_css" onclick="location.href='admin_page_bbs_write.jsp'">
            </span>
        </form>
        <form>
            <div id="searchName">
